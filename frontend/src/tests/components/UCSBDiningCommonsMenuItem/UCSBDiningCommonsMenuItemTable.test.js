...
describe("UCSBDiningCommonsMenuItemTable tests", () => {
  ...
  const expectedHeaders = ["id", "Dining Commons Code", "Station", "Name"];
  ...
  test("Has the expected column headers, content and buttons for admin user", () => {
    ...
    expect(screen.getByTestId(`${testId}-cell-row-0-col-name`)).toHaveTextContent("Taco");

    expect(screen.getByTestId(`${testId}-cell-row-1-col-id`)).toHaveTextContent("2");
    expect(screen.getByTestId(`${testId}-cell-row-1-col-name`)).toHaveTextContent("Spaghetti");
