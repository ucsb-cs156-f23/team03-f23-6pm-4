...
describe("RecommendationRequestEditPage tests", () => {
    ...
    describe("tests where backend is working normally", () => {
        ...
        test("Is populated with the data provided", async () => {
            ...
            expect(requesterEmailField).toHaveValue("student1@email.com");
            expect(professorEmailField).toHaveValue("professor1@email.com");
            expect(explanationField).toHaveValue("for grad school");
