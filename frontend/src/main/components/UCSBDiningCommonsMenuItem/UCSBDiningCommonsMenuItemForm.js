...
function UCSBDiningCommonsMenuItemForm({ initialContents, submitAction, buttonLabel = "Create" }) {
    ...
    const diningCommonsCode_regex = /([0-9])+/i;
                ...
                <Col>
                    <Form.Group className="mb-3" >
                        ...
                        <Form.Control
                            ...
                            {...register("diningCommonsCode", { required: true, pattern: diningCommonsCode_regex })}
                        />
                        <Form.Control.Feedback type="invalid">
                            {errors.diningCommonsCode && 'diningCommonsCode is required. '}
                            {errors.diningCommonsCode?.type === 'pattern' && 'diningCommonsCode must be numeric, e.g. 100'}
